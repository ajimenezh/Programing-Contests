...
The solution to the problem is P(n) (remember that n is N-7,where N is the original parameter n) divided by (1/a_8).


Then the last problem is how to find (P'(n)/(1/a_8))%mod, to solve this we use Fermat Little Theorem that says 
a^p-2 = 1/a (mod p) 
